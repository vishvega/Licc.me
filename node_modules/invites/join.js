    ...
    if (await session.set()) {
        ...
        if (check.invite(invite)) {
            ...
            if (find !== null) {
                ...
                const count = await db.collection("members").countDocuments({ guild_id: ObjectId(guild_id), member_id: ObjectId(session.user_id) }, { limit: 1 });
                        ...
                        if (result !== null) {
                            ...
                            return {
                                ...
                                guild: {
                                    ...
                                    name: result.name,
                                    icon: image.url(result.icon, "icons"),
                                    owner: false,
                                    channels: channels,
