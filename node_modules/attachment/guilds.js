            ...
            if (typeof text === "string") {
                if (Buffer.from(text, "utf8").byteLength <= 1024) {
                    ...
                    if (filename !== null) {
                        ...
                        const result = await db.collection("messages").insertOne({ channel_id: ObjectId(channel_id), user_id: ObjectId(session.user_id), text: text, attachment: filename, date: new Date() });
